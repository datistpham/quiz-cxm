...
import { MdDynamicFeed, MdPlayLesson } from "react-icons/md";
import Feed from "./component/Feed";
import Lession from "./component/lession/Lession";
import CreateLession from "./component/add_lession/AddLession";
  ...
  return (
    ...
    >
            ...
            >
              <Routes>
                <Route path="/">
                  ...
                  <Route path="lession/add" element={<CreateLession />} />
                  {role?.isOwner === true && (
                    <Route
                      path="request"
                      element={
      ...
      {state?.is_invite === true && (
        <Accept request_join_class={request_join_class} />
      )}
    </DetailClassContext.Provider>
  );
};
    ...
    return (
      <div className="wp">
        <div className="list-item-member">
          <div style={{ fontSize: 18, fontWeight: 600 }}>
            Thành viên lớp học ({data?.member_of_class?.length || 0})
          </div>
          <br />
          <Divider />
          <br />
